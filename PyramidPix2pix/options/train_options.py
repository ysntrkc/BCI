...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--which_perceptual", type=str, default="4_2", help="relu5_2 or relu4_2"
        )
        ...
        parser.add_argument(
            "--use_22ctx", action="store_true", help="if true, also use 2-2 in ctx loss"
        )
        parser.add_argument(
            "--lambda_vgg", type=float, default=2, help="weight for vgg loss"
        )
        parser.add_argument("--ctx_w", type=float, default=1.0, help="ctx loss weight")
        parser.add_argument(
            "--PONO", action="store_true", help="use positional normalization "
        )
        ...
        parser.add_argument(
            ...
            type=float,
            default=25,
            help="weight for DWT approximation (LL) loss",
        )
        parser.add_argument(
            "--weight_dwt_detail",
            type=float,
            default=25,
            help="weight for DWT detail (LH, HL, HH) loss",
        )
